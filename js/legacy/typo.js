	...
	var Typo = function () {
	          ...
	          while (1) {
	            switch (_context.prev = _context.next) {
	              case 0:
	                ...
	                setWordsData = function setWordsData(data) {
	                  wData = data;
	                ...
	                setup = function setup() {
	                  ...
	                  _this.rules = _this._parseAFF(aff);
	                  _this.compoundRuleCodes = {};

	                  var _iterator = _createForOfIteratorHelper(_this.compoundRules),
	                      _step;
	                    ...
	                    for (_iterator.s(); !(_step = _iterator.n()).done;) {
	                      ...
	                      if (typeof rule === 'string') {
	                        for (var j = 0; j < rule.length; j++) {
	                          _this.compoundRuleCodes[rule.charAt(j)] = [];
	                        }
	                      }
	                    }
	                  } catch (err) {
	                  ...
	                  if (_this.flags.ONLYINCOMPOUND) {
	                    _this.compoundRuleCodes[_this.flags.ONLYINCOMPOUND] = [];
	                  }

	                  _this.dictionaryTable = _this._parseDIC(wData);

	                  for (var iKey in _this.compoundRuleCodes) {
	                    if (Object.prototype.hasOwnProperty.call(_this.compoundRuleCodes, iKey)) {
	                      if (_this.compoundRuleCodes[iKey].length === 0) {
	                        delete _this.compoundRuleCodes[iKey];
	                      }
	                    }
	                  }
	                  ...
	                  var _iterator2 = _createForOfIteratorHelper(_this.compoundRules),
	                      _step2;

	                  try {
	                    for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
	                      var ruleText = _step2.value;
	                      var expressionText = "";

	                      if (typeof ruleText === 'string') {
	                        var _iterator3 = _createForOfIteratorHelper(ruleText),
	                            _step3;
	                        ...
	                        try {
	                          for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
	                            ...
	                            if (character in _this.compoundRuleCodes) {
	                              expressionText += "(" + _this.compoundRuleCodes[character].join("|") + ")";
	                            } else {
	                        ...
	                        _this.compoundRules[i] = new RegExp(expressionText, "i");
	                        i++;
	                      }
	                    }
	                  } catch (err) {
	                ...
	                isChromeExt = function isChromeExt() {
	                  ...
	                  if (typeof ((_window$chrome = window__default['default'].chrome) === null || _window$chrome === void 0 ? void 0 : (_window$chrome$runtim = _window$chrome.runtime) === null || _window$chrome$runtim === void 0 ? void 0 : _window$chrome$runtim.getURL) === 'function') {
	                    return true;
	                  }
	                ...
	                isBrowserExt = function isBrowserExt() {
	                  var _window$browser, _window$browser$runti;

	                  if (typeof ((_window$browser = window__default['default'].browser) === null || _window$browser === void 0 ? void 0 : (_window$browser$runti = _window$browser.runtime) === null || _window$browser$runti === void 0 ? void 0 : _window$browser$runti.getURL) === 'function') {
	                    return true;
	                  }
	  ...
	  _createClass(Typo, [{
	    ...
	    value: function load(obj) {
	      for (var _i in obj) {
	        if (obj.hasOwnProperty(_i) && Object(this).hasOwnProperty(_i)) {
	          var val = obj[_i];
	          Object.defineProperty(this, _i.toString(), {
	            value: val,
	            writable: true,
	            enumerable: true,
	            configurable: true
	    ...
	    value: function _removeAffixComments(data) {
	      var str = data.replace(/^\s*#.*$/mg, "").replace(/^\s\s*/m, '').replace(/\s\s*$/m, '').replace(/\n{2,}/g, "\n").replace(/^\s\s*/, '').replace(/\s\s*$/, '');
	      return str;
	    }
	  }, {
	    key: "_parseDIC",
	    value: function _parseDIC(data) {
	      ...
	      var addWord = function addWord(key, rules) {
	        if (!dictionaryTable.hasOwnProperty(key)) {
	          dictionaryTable[key] = null;
	        }

	        if (rules.length > 0) {
	          var el = dictionaryTable[key];
	        ...
	        if (parts.length > 1) {
	          ...
	          for (var j = 0; j < jlen; j++) {
	            ...
	            if (rule) {
	              ...
	              var _iterator4 = _createForOfIteratorHelper(newWords),
	                  _step4;

	              try {
	                for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {
	                  var newWord = _step4.value;
	                  addWord(newWord, []);
	                    ...
	                    for (var k = j + 1; k < jlen; k++) {
	                      ...
	                      if (combineRule) {
	                        if (combineRule.combineable && rule.type !== combineRule.type) {
	                          ...
	                          var _iterator5 = _createForOfIteratorHelper(otherNewWords),
	                              _step5;

	                          try {
	                            for (_iterator5.s(); !(_step5 = _iterator5.n()).done;) {
	                              var otherNewWord = _step5.value;
	    ...
	    value: function parseRuleCodes(textCodes) {
	      if (!textCodes || this.flags === undefined) {
	        ...
	        for (var _i3 = 0; _i3 < textCodes.length; _i3 += 2) {
	          pFlags.push(textCodes.substr(_i3, 2));
	        }
	    ...
	    value: function hasFlag(word, strFlag, wordFlags) {
	      ...
	      if (strFlag in this.flags) {
	        if (typeof wordFlags === 'undefined') {
	          var tableItem = this.dictionaryTable[word];
	    ...
	    value: function suggest(word) {
	      ...
	      var edits1 = function edits1(words) {
	        var knownOnly = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
	        var rv = {};
	        var i;
	        var j;
	        var numLen;
	        ...
	        for (var _wrd in words) {
	          if (Object.prototype.hasOwnProperty.call(words, _wrd)) {
	            for (i = 0, numLen = _wrd.length + 1; i < numLen; i++) {
	              var strSub = [_wrd.substring(0, i), _wrd.substring(i)];
	      ...
	      var correct = function correct(wrd) {
	        var ed1 = edits1(wrd);
	        ...
	        for (var j in weightedCorrections) {
	        ...
	        var workingLimit = limit;

	        for (i = 0; i < Math.min(workingLimit, sortedCorrections.length); i++) {
	          var sortString = sortedCorrections[i][0].toString();
	          var update = false;
